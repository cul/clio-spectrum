...
# set :bundle_env_variables, 'http_proxy' => 'http://lito-squid-prod2.cul.columbia.edu:3131',
#                            'https_proxy' => 'https://lito-squid-prod2.cul.columbia.edu:3131'
...
set :deploy_to, '/opt/clio/batch_test'
