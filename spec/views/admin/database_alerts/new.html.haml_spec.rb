...
describe "admin_database_alerts/new" do
  before(:each) do
    assign(:database_alert, stub_model(Admin::DatabaseAlert,
      :clio_id => 1,
      :author_id => 1,
      :active => false,
      :message => "MyText"
  ...
  it "renders new database_alert form" do
    ...
    assert_select "form", :action => admin_database_alerts_path, :method => "post" do
