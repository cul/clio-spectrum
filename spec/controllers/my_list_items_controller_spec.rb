...
describe MyListItemsController do
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved list_item as @list_item" do
        ...
        post :create, {:list_item => { "list_id" => "invalid value" }}, valid_session
        assigns(:list_item).should be_a_new(ListItem)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested list_item" do
        ...
        ListItem.any_instance.should_receive(:update_attributes).with({ "list_id" => "1" })
        put :update, {:id => list_item.to_param, :list_item => { "list_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the list_item as @list_item" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        ListItem.any_instance.stub(:save).and_return(false)
        put :update, {:id => list_item.to_param, :list_item => { "list_id" => "invalid value" }}, valid_session
        assigns(:list_item).should eq(list_item)
      end
