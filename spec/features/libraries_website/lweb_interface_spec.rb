...
# LIBSYS-3061 - Google Custom Search Javascript Widget 
# does not have format icons.
# 
...
# LIBSYS-3061 - Now using Google widget - don't run local
# testing for internals of google-controlled widget
