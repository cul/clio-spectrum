...
describe 'Item Locations should show correct library hours', :skip_travis do
  # before(:all) do
  ...
  it 'for Avery Drawings & Archives', :js do
    ...
    expect(page).to have_link('Full Hours Info', href: 'https://hours.library.columbia.edu/locations/avery-drawings-archives')
  end
