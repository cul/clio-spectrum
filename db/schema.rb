...
ActiveRecord::Schema.define(version: 20_130_702_170_157) do
  ...
  add_index 'item_alerts', %w(source item_key), name: 'index_item_alerts_on_source_and_item_key'
  add_index 'item_alerts', %w(start_date end_date), name: 'index_item_alerts_on_start_date_and_end_date'
  ...
  add_index 'library_hours', %w(library_id date), name: 'index_library_hours_on_library_id_and_date'
  ...
  add_index 'options', %w(entity_type entity_id association_type name), name: 'entity_association_name'
  ...
  add_index 'saved_list_items', %w(saved_list_id item_key), name: 'index_saved_list_items_on_saved_list_id_and_item_key', unique: true
  ...
  add_index 'saved_lists', %w(owner name), name: 'savedlist_name', unique: true
  add_index 'saved_lists', %w(owner slug), name: 'savedlist_url', unique: true
