...
ActiveRecord::Schema.define(version: 20_181_001_010_101) do
  ...
  create_table 'item_alerts', force: :cascade do |t|
    ...
    t.datetime 'created_at'
    t.datetime 'updated_at'
    t.index %w(source item_key), name: 'index_item_alerts_on_source_and_item_key'
    t.index %w(start_date end_date), name: 'index_item_alerts_on_start_date_and_end_date'
  end
  ...
  create_table 'library_hours', force: :cascade do |t|
    ...
    t.index %w(library_id date), name: 'index_library_hours_on_library_id_and_date'
  end
  ...
  create_table 'options', force: :cascade do |t|
    ...
    t.datetime 'created_at'
    t.datetime 'updated_at'
    t.index %w(entity_type entity_id association_type name), name: 'entity_association_name'
  end
  ...
  create_table 'saved_list_items', force: :cascade do |t|
    ...
    t.datetime 'created_at'
    t.datetime 'updated_at'
    t.index %w(saved_list_id item_key), name: 'index_saved_list_items_on_saved_list_id_and_item_key', unique: true
  end
  ...
  create_table 'saved_lists', force: :cascade do |t|
    ...
    t.datetime 'created_at'
    t.datetime 'updated_at'
    t.index %w(owner name), name: 'savedlist_name', unique: true
    t.index %w(owner slug), name: 'savedlist_url', unique: true
  end
