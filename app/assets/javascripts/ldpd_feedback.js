...
LWEB.setupFeedbackDialog = function() {
    $('<div id="feedback_dialog"><a id="close_feedback_dialog" href="#" onclick="LWEB.hideFeedbackDialog();"><span class="glyphicon glyphicon-remove"></span></a><iframe width="600" height="400" src="https://feedback.cul.columbia.edu/feedback_submission/clio?current_page=' + window.location.href + '"></iframe></div>').hide().appendTo('body');
    $('#feedback_dialog').css(
        {
        'z-index':'10000',
        'position':'absolute'
