...
module HoldingsHelper
  ...
  SERVICE_ORDER = %w(campus_scan recap_scan offsite ill_scan ill campus_paging campus_paging_pilot flip_paging recap_loan barnard_remote barnard_alum avery_onsite aeon microform precat on_order borrow_direct recall_hold in_process doc_delivery ).freeze
  ...
  def serviceConfig
    ...
    # now we can call methods as we build the config.
    {
      ...
      'campus_paging_pilot'  => {link_label: 'Pick-Up (Pilot)',       service_url: campus_paging_pilot_link, 
                           tooltip:    'Campus Paging Pilot', js_function: 'OpenWindow'},
  ...
  def campus_paging_pilot_link
    valet_url = APP_CONFIG['valet_url'] || 'https://valet.cul.columbia.edu'
    "#{valet_url}/campus_paging_pilot/"
  end
