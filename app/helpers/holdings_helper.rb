...
module HoldingsHelper
  ...
  SERVICE_ORDER = %w(campus_scan recap_scan offsite ill_scan ill campus_paging campus_paging_pilot fli_paging recap_loan barnard_remote barnard_alum avery_onsite aeon microform precat on_order borrow_direct recall_hold in_process doc_delivery ).freeze
